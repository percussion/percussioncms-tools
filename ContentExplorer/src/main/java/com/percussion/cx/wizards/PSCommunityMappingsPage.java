...
public class PSCommunityMappingsPage extends PSWizardPanel
{
    ...
    * Get the panel data.
    * 
    * @return the panel data as {@link PSCommunityMappingsPage.OutputData} 
    ...
    * 
    * @param data the data as {@link PSCommunityMappingsPage.InputData}
    ...
    *    of {@link PSCommunityMappingsPage.InputData}.
    */
