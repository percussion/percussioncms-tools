...
public class PSActionManager implements IPSConstants, IPSSelectionListener
{
         ...
         while (nodes.hasNext())
         {
            ...
            if (!node.areDynamicPropsLoaded())
            {
               try
               {
                  ...
                  String ctID = node.getProp(IPSConstants.PROPERTY_CONTENTTYPEID);
         ...
         String mode)
   {
      ...
      if (nodeProps != null)
      {
         ...
         while (iter.hasNext())
         {
             ...
             * action
             */
            if (action.getName().equals(IPSConstants.ACTION_FORCE_CHECKIN)
                  && key.equals(IPSConstants.PROPERTY_REVISION))
            {
   ...
   /**
    * Easy access method for
    * {@link com.percussion.cx.PSContentExplorerApplet#getIcon(String)}. See the
