...
/**
 * The class to encapsulate property definition
 */
public class PSProperty extends PSNameValuePair implements java.io.Serializable
{
   /**
    ...
    */
   public PSProperty(String name, String value)
   {
      super(name, value);
   }
    ...
    */
   public PSProperty(Element source) throws PSUnknownNodeTypeException
   {
      super(source);
   }
