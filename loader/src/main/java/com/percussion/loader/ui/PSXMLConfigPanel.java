...
/**
 * Implements configuration panel that is specific for the XML extractors.
 */
public class PSXMLConfigPanel extends PSItemExtractorConfigPanel
{
   ...
   {
      return new PSFieldConfigTabPanel(true);
   }
