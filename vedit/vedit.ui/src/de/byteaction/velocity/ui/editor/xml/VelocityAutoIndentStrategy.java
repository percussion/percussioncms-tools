 ...
 */
public class VelocityAutoIndentStrategy extends DefaultAutoIndentStrategy
{
    ...
    public void smartIndentAfterNewLine(IDocument doc, DocumentCommand cmd)
    {
        ...
        try
        {
            ...
            if (EditorsUtil.isInsidePartition(p, new String[] { "__comment_partition", "__tag_partition" }, doc))
            {
