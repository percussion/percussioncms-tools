...
import de.byteaction.velocity.ui.editor.xml.IgnoreCasePatternRule;
...
import de.byteaction.velocity.vaulttec.ui.editor.text.EmptyCommentDetector;
...
public class VelocityPartitionScanner extends RuleBasedPartitionScanner implements IEditorConfiguration
{
    ...
    /*
     * (non-Javadoc)
     * @see de.byteaction.velocity.vaulttec.ui.editor.xml.IEditorConfiguration#getTabWidth(org.eclipse.jface.text.source.ISourceViewer)
     */
