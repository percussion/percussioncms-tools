 ...
 * {@link PSObjectTypes#UI_DISPLAY_FORMAT}. Uses base class implementation
 ...
 */
public class PSUiDisplayFormatModelProxy extends PSCmsModelProxy
{
   /**
    * Ctor. Invokes base class version with the object type
    * {@link PSObjectTypes#UI_DISPLAY_FORMAT} and for main type and
    * <code>null</code> sub type since this object type does not have any sub
    * types.
    */
   public PSUiDisplayFormatModelProxy()
   {
      super(PSObjectTypes.UI_DISPLAY_FORMAT);
   }
