 ...
 * {@link PSObjectTypes#SLOT}. Uses base class implementation whenever possible
 ...
 */
public class PSSlotModelProxy extends PSCmsModelProxy
{
   /**
    * Ctor. Invokes base class version with the object type
    * {@link PSObjectTypes#SLOT} and for main type and <code>null</code> sub
    * type since this object type does not have any sub types.
    */
   public PSSlotModelProxy()
   {
