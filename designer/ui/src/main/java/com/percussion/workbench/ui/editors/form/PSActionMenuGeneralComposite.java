/******************************************************************************
 *
 * [ PSActionMenuGeneralComposite.java ]
 *
...
public class PSActionMenuGeneralComposite extends Composite
   implements IPSDesignerObjectUpdater
{
    ...
    * @param style
    */
   public PSActionMenuGeneralComposite(
      Composite parent, int style, PSEditorBase editor, int page)
   {
      ...
      m_commonComp = new PSNameLabelDesc(this, SWT.NONE,
         PSMessages.getString("PSActionMenuGeneralComposite.menu.label"), -1, //$NON-NLS-1$
   ...
   public void loadControlValues(Object designObject)
   {
      ...
      m_accelComp.loadControlValues(action);
   }
