 ...
 * for managing security, initially communities and roles.
 * 
 * @version 6.0
 * @author paulhoward
 */
public class PSSecurityDesignView extends PSDeclarativeExplorerView
{
   /**
    * The view id as specified in the plugin.xml.
    */
   public static final String ID = 
      "com.percussion.workbench.ui.views.PSSecurityDesignView";
