/*******************************************************************************
 *
 * [ PSWidgetXmlServerDesignView.java ]
 * 
 ...
 * @author paulhoward
 */
public class PSWidgetXmlServerDesignView extends PSDeclarativeExplorerView
{
   /**
    * The view id as specified in the plugin.xml.
    */
   public static final String ID = 
      "com.percussion.workbench.ui.views.PSWidgetXmlServerDesignView";

   //see base class
   @Override protected String getRootName()
   {
      return "widget-xmlserver";
   }
}
