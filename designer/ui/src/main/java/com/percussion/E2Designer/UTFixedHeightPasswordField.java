/*[ UTFixedHeightPasswordField.java ]******************************************
 *
...
/**
 * Just like a standard password editor with a slight change in the resizing
 * behavior. When used with a Box layout, it will take up all available width,
 * but is limited in height.
 */
public class UTFixedHeightPasswordField extends JPasswordField
{
   /**
