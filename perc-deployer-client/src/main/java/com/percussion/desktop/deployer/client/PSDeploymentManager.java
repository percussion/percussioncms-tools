...
package com.percussion.desktop.deployer.client;
...
public class PSDeploymentManager
{
    ...
    * {@link PSCataloger} class returned by a call
    ...
    * server using the {@link PSCataloger} class
    ...
    * the server using the {@link PSCataloger}
