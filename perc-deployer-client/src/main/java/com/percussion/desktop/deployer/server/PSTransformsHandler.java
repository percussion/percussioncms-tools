 ...
 */
package com.percussion.desktop.deployer.server;

import com.percussion.desktop.deployer.PSMappingElement;
...
import com.percussion.desktop.deployer.objectstore.PSIdMap;
import com.percussion.desktop.deployer.objectstore.PSIdMapping;
...
public class PSTransformsHandler 
{
   ...
   private void guessTarget(PSIdMapping mapping, boolean mustMatchById)
      ...
      com.percussion.desktop.deployer.PSMappingElement targetEl = guessTarget(
    ...
    */
   private com.percussion.desktop.deployer.PSMappingElement guessTarget(String elementType, String sourceName,
                                                                        String sourceId, String parentType, String parentId,
                                                                        boolean mustMatchById) throws PSDeployException, PSNotFoundException {
      List<com.percussion.desktop.deployer.PSMappingElement> targetElements = getUnmappedTargetElements(
            elementType, parentType, parentId);      
               
      List<com.percussion.desktop.deployer.PSMappingElement> matchingElements =
         new ArrayList<com.percussion.desktop.deployer.PSMappingElement>();
      //guess by name
      Iterator<com.percussion.desktop.deployer.PSMappingElement> elements = targetElements.iterator();
      while (elements.hasNext())
      {
         com.percussion.desktop.deployer.PSMappingElement target = elements.next();
         if (target.getName().equalsIgnoreCase(sourceName))
            matchingElements.add(target);
      }

      com.percussion.desktop.deployer.PSMappingElement target = null;
      if (!matchingElements.isEmpty())
      {
         ...
         {
            com.percussion.desktop.deployer.PSMappingElement tg = elements.next();
    ...
    */
   @SuppressWarnings("unchecked")
   private List<com.percussion.desktop.deployer.PSMappingElement> getUnmappedTargetElements(String objectType,
      ...
      List<com.percussion.desktop.deployer.PSMappingElement> targetElements = new ArrayList<com.percussion.desktop.deployer.PSMappingElement>();
      ...
      Iterator<com.percussion.desktop.deployer.PSMappingElement> iter = getElementsByType(objectType);
      while (iter.hasNext())
      {
         com.percussion.desktop.deployer.PSMappingElement element = iter.next();
    ...
    * {@link com.percussion.desktop.deployer.PSMappingElement} for details.
    *
    ...
    */
   @SuppressWarnings("unchecked")
   private Set<com.percussion.desktop.deployer.PSMappingElement> getMappingElements(String type)
           throws PSDeployException, PSNotFoundException {
      Set<com.percussion.desktop.deployer.PSMappingElement> mapElems = new HashSet<com.percussion.desktop.deployer.PSMappingElement>();
      ...
      while (iter.hasNext())
      {
         ...
         com.percussion.desktop.deployer.PSMappingElement element = new com.percussion.desktop.deployer.PSMappingElement(dep.getObjectType(),
    ...
    */
   @SuppressWarnings("unchecked")
   private Iterator<com.percussion.desktop.deployer.PSMappingElement> getElementsByType(String type)
           throws PSDeployException, PSNotFoundException {
      ...
      {
         List<com.percussion.desktop.deployer.PSMappingElement> elements = new ArrayList<com.percussion.desktop.deployer.PSMappingElement>();
         if (hasParentType(type))
         {
            String parentType = getParentType(type);
            Iterator<com.percussion.desktop.deployer.PSMappingElement> parentIter = getElementsByType(
                  parentType);
            while (parentIter.hasNext())
            {
               com.percussion.desktop.deployer.PSMappingElement parentElement = parentIter.next();
               ...
               while (childElements.hasNext())
               {
                  ...
                  com.percussion.desktop.deployer.PSMappingElement childElement = new com.percussion.desktop.deployer.PSMappingElement(
    ...
    */
   private Map<String, List<com.percussion.desktop.deployer.PSMappingElement>> m_typeToMapElems =
