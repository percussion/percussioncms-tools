...
{   
   ...
   */
      ...
      throws PSUnknownNodeTypeException   
   {
      ...
      m_isDefault = 
         XML_ATTR_TRUE.equals(source.getAttribute(XML_DEFAULT_ATTR));
   ...
   public Element toXml(Document doc)
   {
      ...
      el.setAttribute(XML_USE_SSL_ATTR, m_useSSL ? XML_ATTR_TRUE : 
         XML_ATTR_FALSE);
      el.setAttribute(XML_DEFAULT_ATTR, m_isDefault ? XML_ATTR_TRUE : 
         XML_ATTR_FALSE);
   ...
   {
      if(isSaveCredentials() && StringUtils.isBlank(userName))
   ...
   /**
    * Sets the is Default setting for this registration.
    * 
    * @param isDefault <code>true</code> if the registration is the
    * default.
    */
   ...
   /**
    * Gets the isDefault setting for this registration.
    * 
    * @return <code>true</code> if this is the default registration.
    */
   ...
   {
      if(obj == null || !(obj instanceof PSServerRegistration))
         return false;
      PSServerRegistration sr = (PSServerRegistration)obj;
      return new EqualsBuilder().
         append(m_server, sr.m_server).
         append(m_port, sr.m_port).
         isEquals();      
   }
   ...
   /**
    * Indicates that this is the default server.
    */
   ...
   private static final String XML_DEFAULT_ATTR = "isDefault";
